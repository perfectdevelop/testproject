...
export const activateAccount = expressAsyncHandler(async (req, res) => {
...
export const userUnfollow = expressAsyncHandler(async (req, res) => {
...
export const newPassword = expressAsyncHandler(async (req, res) => {
