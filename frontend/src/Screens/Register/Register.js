...
const Register = () => {
  ...
  const submitHandler = (e) => {
    ...
    dispatch(register(firstname, lastname, age, region, email, password, image));
  };
  ...
  return (
    <>
      <div className="register">
        <div className="register-header">
          <div className="container">
            <span className="register-header-title">Create AS Account</span>
            <span className=" register-header-login">
              <Link to="/signin" className="btn register-header-login-link">
      ...
      <div
        className="section-full content-inner-2 shop-account bg-white"
              ...
              <div className="p-a30 border-1  max-w500 m-auto">
                <div className="tab-content">
                  <form id="login" className="tab-pane active">
                    ...
                    <div className="form-group">
                      <label htmlFor="registerFormRegion">Region</label>
                      <select
                        className="form-control"
